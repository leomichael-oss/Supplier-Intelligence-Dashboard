...
const suppliers = [
  sup({
    ...
    external: {
      marketCapLabel: "$275.78B",
      marketCapAsOf: "Feb 25, 2026",
      marketCapYoy: 13.66,
      stockPriceLabel: "$107.20",
      stockPriceYoy: 13.66,
      summary: [
  ...
  sup({
    ...
    external: {
      marketCapLabel: "$29.33B",
      marketCapAsOf: "Feb 25, 2026",
      marketCapYoy: -17.56,
      stockPriceLabel: "$24.78",
      stockPriceYoy: -17.56,
      summary: [
  ...
  sup({
    ...
    external: {
      marketCapLabel: "$231.81B",
      marketCapAsOf: "Feb 25, 2026",
      marketCapYoy: 13.49,
      stockPriceLabel: "$169.54",
      stockPriceYoy: 13.49,
      summary: [
  ...
  sup({
    ...
    external: {
      marketCapLabel: "$386.21B",
      marketCapAsOf: "Feb 25, 2026",
      marketCapYoy: -1.81,
      stockPriceLabel: "$165.28",
      stockPriceYoy: -1.81,
  ...
  sup({
    ...
    external: {
      marketCapLabel: "$2.52B",
      marketCapAsOf: "Feb 25, 2026",
      marketCapYoy: 32.82,
      stockPriceLabel: "$20.25",
      stockPriceYoy: 32.82,
  ...
  sup({
    ...
    external: {
      marketCapLabel: "$12.58B",
      marketCapAsOf: "Feb 25, 2026",
      marketCapYoy: 74.16,
      stockPriceLabel: "$31.05",
      stockPriceYoy: 74.16,
  ...
  sup({
    ...
    external: {
      marketCapLabel: "$24.23B",
      marketCapAsOf: "Feb 25, 2026",
      marketCapYoy: -24.27,
      stockPriceLabel: "$45.42",
      stockPriceYoy: -24.27,
  ...
  sup({
    ...
    external: {
      marketCapLabel: "$29.03B",
      marketCapAsOf: "Feb 25, 2026",
      marketCapYoy: 3.03,
      stockPriceLabel: "$83.44",
      stockPriceYoy: 3.03,
  ...
  sup({
    ...
    external: {
      marketCapLabel: "$347.22B",
      marketCapAsOf: "Feb 25, 2026",
      marketCapYoy: 16.01,
      stockPriceLabel: "$80.72",
      stockPriceYoy: 16.01,
  ...
  sup({
    ...
    external: {
      marketCapLabel: "$163.09B",
      marketCapAsOf: "Feb 25, 2026",
      marketCapYoy: 35.84,
      stockPriceLabel: "$74.59",
      stockPriceYoy: 35.84,
  ...
  sup({
    ...
    external: {
      marketCapLabel: "$46.68B",
      marketCapAsOf: "Feb 25, 2026",
      marketCapYoy: 31.54,
      stockPriceLabel: "$230.21",
      stockPriceYoy: 31.54,
  ...
  sup({
    ...
    external: {
      marketCapLabel: "$38.94B",
      marketCapAsOf: "Feb 25, 2026",
      marketCapYoy: 34.61,
      stockPriceLabel: "$16,647",
      stockPriceYoy: 34.61,
  ...
  sup({
    ...
    external: {
      marketCapLabel: "$253.49B",
      marketCapAsOf: "Feb 25, 2026",
      marketCapYoy: 32.74,
      stockPriceLabel: "$474.91",
      stockPriceYoy: 32.74,
  ...
  sup({
    ...
    external: {
      marketCapLabel: "$36.42B",
      marketCapAsOf: "Feb 25, 2026",
      marketCapYoy: -16.91,
      stockPriceLabel: "$19.01",
      stockPriceYoy: -16.91,
